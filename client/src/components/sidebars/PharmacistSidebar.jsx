...
function PharmacistSidebar({ children }) {
  ...
  const menus = [
    ...
    },
    {
      ...
      link: "/pharmacist/provide_medications",
      icon: GiMedicines,
    },
    { name: "Patients", link: "/pharmacist/patients", icon: IoIosPeople },
    { name: "Profile", link: "/pharmacist/profile", icon: AiOutlineSetting },
  ];
          ...
          <div className="text-xl text-gray-900 w-full bg-gray-50">
            <div className="bg-white h-16 p-4 flex items-center justify-between gap-3">
              <h1 className="text-indigo-900 text-lg lg:text-2xl font-bold flex items-center gap-2">
                {React.createElement(GiNurseMale, { size: "20" })}PHARMACIST
              </h1>
